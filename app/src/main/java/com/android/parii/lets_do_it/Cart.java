...
import com.android.parii.lets_do_it.Model.Request;
import com.android.parii.lets_do_it.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    private void showAlertDialog() {
        ...
        alertDialog.setTitle("just one MoreStep!!");
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(getBaseContext(),"Thanks, you'll recieve a call soon",Toast.LENGTH_LONG).show();
                finish();
